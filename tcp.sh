...
#	Description: BBR For Oracle Cloud.
#	Version: 1.3.2
#	Original author: 千影,cx9208
#      	Rebuilder: Anthony Deng
#	Blog: https://tiandynasty.cn/
#=================================================

sh_ver="1.3.2"
github="raw.githubusercontent.com/anthonydeng2000/Oracle-BBR/master"
...
echo && echo -e " BBR加速 一键安装管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
  -- BBR For Oracle Cloud | tiandynasty.cn --
————————————内核管理————————————
